                        ...
                        <div class="bg-white p-4 p-md-5 rounded shadow-sm">
                            ...
                            <form method="POST" action="AutentikasiServlet">
                                ...
                                <div class="row gy-3 gy-md-4 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn btn-lg btn-primary" type="submit" name="aksi" value="login">Log in now</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                        <a href="?pg=register" class="link-secondary text-decoration-none">Create new account</a>
                                    </div>
                                </div>
                            </div>
                        </div>
